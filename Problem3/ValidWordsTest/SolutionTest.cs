...
public class SolutionTest
{
    ...
    public void TestMethod1()
    {
        ...
        Assert.AreEqual(3, solution.CountValidWords(sentence));
    }
    ...
    public void TestMethod2()
    {
        ...
        Assert.AreEqual(0, solution.CountValidWords(sentence));
    }
    ...
    public void TestMethod3()
    {
        ...
        Assert.AreEqual(5, solution.CountValidWords(sentence));
    }
    ...
    public void TestMethod4()
    {
        ...
        Assert.AreEqual(6, solution.CountValidWords(sentence));
    }
    ...
    public void TestMethod5()
    {
        ...
        Assert.AreEqual(50, solution.CountValidWords(sentence));
    }
    ...
    public void TestMethod6()
    {
        ...
        Assert.AreEqual(49, solution.CountValidWords(sentence));
    }
}